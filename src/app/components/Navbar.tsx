...
//                                     <p className="rounded-md px-3 py-2 text-lg font-medium text-violet-700 hover:text-white transition duration-200 ease-in-out">
//                                         Dashboard
//                                     </p>
//                                 </Link>
//                             )}
...
//                     </div>
//                 </div>
//                 <div className="flex items-center"> {/* Align ConnectButton to the right */}
//                     <button><Link href="/api/auth/signin">Github Signin</Link></button>
//                     <ConnectButton
//                         client={client}
//                         theme={lightTheme()}
//                         detailsButton={{
